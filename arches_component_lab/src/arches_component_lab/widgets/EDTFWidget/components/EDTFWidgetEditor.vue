...
<template>
    <div class="field-with-button">
        ...
        >
            ...
            <p>
                The EDTF datatype allows you to describe dates (even uncertain
                dates). You can find a summary of the standard here: EDTF Date
                Specfication (Library of Congress)
            </p>
            ...
            <p><b>1964/2008</b></p>
            <p>
                A time interval with calendar year precision, beginning sometime
                in 1964 and ending sometime in 2008
            </p>
            <p><b>2004-06/2006-08</b></p>
            <p>
                A time interval with calendar month precision, beginning
                sometime in June 2004 and ending sometime in August of 2006
            </p>
            ...
            <p><b>Y-100000</b></p>
            <p>
                The year -100000. 'Y' may be used at the beginning of the date
                string to signify that the date is a year, when (and only when)
                the year exceeds four digits, i.e. for years later than 9999 or
                earlier than -9999.
            </p>
            <p><b>2001-21</b></p>
            <p>
                Spring, 2001. The values 21, 22, 23, 24 may be used used to
                signify ' Spring', 'Summer', 'Autumn', 'Winter', respectively,
                in place of a month value (01 through 12) for a year-and-month
                format string
            </p>
            <p><b>1984?</b></p>
